...
import { Plus, Search, Calendar, MapPin, Eye, Edit, Edit2, ExternalLink, Trash2, QrCode, Copy, Archive, X, Sparkles, Clock, CalendarClock, Unlock, RefreshCw, AlertCircle, Check } from "lucide-react";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl max-w-md w-full border border-slate-200 shadow-2xl p-6 relative animate-scale-in">
            ...
            <div className="space-y-4">
              ...
              <div className="text-xs text-rose-600 font-bold flex items-center justify-center gap-1.5 border border-rose-100 bg-rose-50 p-2.5 rounded-xl">
                ...
                <div className="space-y-2">
                  ...
                  {confirmNameInput.trim().toLowerCase() !== deletingEvent.name.trim().toLowerCase() ? (
                    ...
                    <p className="text-[10px] text-emerald-600 font-bold flex items-center gap-1">
                      ...
                      <span>Name confirmed. Delete button unlocked.</span>
                    </p>
                  )}
                </div>
              )}
