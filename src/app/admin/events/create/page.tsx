    ...
    <div className="space-y-6 text-white max-w-5xl mx-auto pb-12">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div key={field.id} className="flex items-center justify-between bg-[#161822] p-3 rounded-lg border border-gray-800">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Type: <span className="text-amber-500 uppercase">{field.type}</span> | Required: {field.required ? "Yes" : "No"}
                      </p>
                    </div>
                    <button
                      type="button"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#0c0d12] p-6 rounded-xl border border-gray-800 space-y-4">
            <h2 className="text-lg font-bold text-amber-500 uppercase tracking-wide border-b border-gray-850 pb-2">Financials & Partner</h2>
          ...
          <div className="bg-[#0c0d12] p-6 rounded-xl border border-gray-800 space-y-4">
            ...
            <button
              ...
              className="w-full bg-transparent hover:bg-amber-500 hover:text-black border border-amber-500/30 text-amber-500 font-bold py-2 rounded transition text-sm flex items-center justify-center space-x-1"
            >
          ...
          <button
            type="submit"
            className="w-full bg-amber-500 hover:bg-amber-600 text-black font-extrabold py-3.5 rounded-xl transition duration-200"
          >
            Save Event Draft
          </button>
