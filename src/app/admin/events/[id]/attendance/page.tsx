            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2.5 text-red-600">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-slate-400 font-medium truncate">Event: {event?.name}</p>
                </div>
              </div>
              <button
                type="button"
            ...
            {closeSuccessMsg ? (
              ...
              <>
                ...
                <div className="grid grid-cols-3 gap-2 p-3 bg-slate-50 rounded-2xl border border-slate-200 text-center">
                  <div>
                    <span className="text-[10px] font-bold text-slate-400 uppercase block">Total Registered</span>
                    <span className="text-lg font-black text-slate-900">{totalEligible}</span>
                  </div>
                  <div>
                    <span className="text-[10px] font-bold text-emerald-600 uppercase block">Present</span>
                    <span className="text-lg font-black text-emerald-600">{presentCount + lateCount}</span>
                  </div>
                  <div>
                ...
                <div className="space-y-2 text-xs text-slate-600 bg-amber-50/70 border border-amber-200 p-3.5 rounded-2xl">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-slate-700 text-[11px] pl-1">
                    ...
                    <li><strong>{presentCount + lateCount} Present</strong> candidates are marked as <strong>ATTENDED</strong>.</li>
                    <li><strong>{absentCount} Absent</strong> candidates are marked as <strong>ABSENT</strong> and their student profiles are placed <strong>ON HOLD</strong> (future registrations restricted).</li>
