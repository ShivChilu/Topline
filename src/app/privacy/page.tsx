    ...
    <div className="flex flex-col min-h-screen bg-[#07080b] text-white">
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 py-16 text-left space-y-6">
        ...
        <div className="text-gray-300 space-y-4">
          <p>
            At Top Line Catering, accessible from Top Line platforms, one of our main priorities is the privacy of our visitors and student candidates. This Privacy Policy document contains types of information that is collected and recorded by Top Line and how we use it.
          </p>
